const translations = {
  fr: {
    ...
    'contact': 'Contact',
    'no-available-cars': 'Aucune voiture disponible',
    'no-available-message': 'Aucune voiture disponible immédiatement pour le moment.',
    'load-more': 'Charger Plus',
    'location': 'Emplacement',
    'non-car': 'Aucun résultat trouvé',
    'sur-commande': 'Sur Commande',
    'see-all': ' Voir toutes les voitures',
    'back': 'Retour',
    ...
    "no-results-found": "Aucun résultat pour",
    "result": "résultat",
    "results": "résultats",
    "no-results-title": "Aucun résultat trouvé",
    "no-results-message": "Aucune voiture ne correspond à",
    "in-category": "dans la catégorie",
    "see-all-cars": "Voir toutes les voitures",
    "search-error": "Erreur lors de la recherche. Veuillez réessayer.",
    ...
    'search-placeholder': 'Rechercher une voiture...',
    'search-button': 'Rechercher',
    'no-results-search': 'Aucun résultat trouvé',
    'technical-specs': 'Specifications techniques',
    'basic-details': 'Details de base',
    'power': 'Puissance',
    'cylindre': 'Cylindres',
    'abs': 'ABS',
  ...
  ar: {
    ...
    'location': 'الموقع',
    'back': 'عودة',
    'see-all': 'عرض جميع السيارات',
    'non-car': 'لم يتم العثور على نتائج',
    ...
    "searching": "البحث عن",
    "no-results-found": "لا توجد نتائج لـ",
    "result": "نتيجة",
    "results": "نتائج",
    "no-results-title": "لم يتم العثور على نتائج",
    "no-results-message": "لا توجد سيارة تطابق",
    "in-category": "في الفئة",
    "see-all-cars": "عرض جميع السيارات",
    "search-error": "خطأ في البحث. يرجى المحاولة مرة أخرى.",
    ...
    'back-to-all': 'عرض جميع السيارات',
    'no-available-message': 'لا توجد سيارات متوفرة فورًا في الوقت الحالي.',
    'no-available-cars': 'لا توجد سيارات متوفرة',
    'car-not-found': 'السيارة غير موجودة',
    'loading-error': 'خطأ في التحميل',
    'search-placeholder': 'البحث عن سيارة...',
    'search-button': 'بحث',
    'no-results-search': 'لم يتم العثور على نتائج',
    'description': 'الوصف:',
    'location-btn': 'الموقع',
    'call-btn': 'اتصل',
